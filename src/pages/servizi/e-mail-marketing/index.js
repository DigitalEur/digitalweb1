                        ...
                        <Row className="justify-content-center">
                            ...
                            <Col lg="9" xs="12" className="text-justify">
                                ...
                                <p className="lead text-center">
                                    <b><i>L’e-mail marketing è un alleato fondamentale per qualsiasi attività al fine di
                                        aumentare il
                                        proprio business</i></b>
                                </p>
                                <p className="lead">
                                    L’<b>E-mail marketing</b> è un modello di marketing diretto che utilizza la posta
                                    elettronica per
                                    comunicare alla propria audience messaggi promozionali su prodotti e servizi,
                                    messaggi informativi che
                                    hanno l’obiettivo di <b>fidelizzare i clienti</b>.
                                </p>

                                <p className="lead">
                                    Attenendosi alla normativa <b>GDPR</b> in materia di protezione dei dati personali,
                                    che permette di
                                    svolgere attività di comunicazione promozionale, è possibile creare una certa
                                    confidenza con i propri
                                    utenti che rilasciano volontariamente il proprio contatto. In questo modo l’utente
                                    sarà invogliato a
                                    tornare sul nostro sito per rimanere sempre informato delle nostre novità,
                                    promozioni, sconti e
                                    quant’altro!
                                </p>

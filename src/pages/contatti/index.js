                            ...
                            <Col lg="8">
                                <Card className="bg-gradient-secondary shadow">
                                    <CardBody className="p-lg-5">
                                        ...
                                        <form action="https://getform.io/f/00b56a7a-2481-4197-9a17-b8ea83a6952e"
                                              method="POST">
                                            ...
                                            <FormGroup>
                                                <InputGroup className="input-group-alternative">
                                                    ...
                                                    <Input type="select" name="select" id="exampleSelect">
                                                        <option disabled selected value> -- seleziona un servizio --
                                                        </option>
                            ...
                            <Col lg="4">
                                <div className="text-center">
                                    <img
                                        ...
                                        marginRight="auto"
                                    />
                                    <h4 className="mt-2 mb-1 text-center" style={{fontFamily: "Times New Roman", color: "#0e4794"}}>Sede
                                        Milano</h4>
                                    ...
                                    <p className="my-0 text-center" style={{fontFamily: "Times New Roman", color: "#0e4794"}}>
                                        europadigitaldivision@gmail.com
                                    </p>
                                    <p className="mt-0 text-center" style={{fontFamily: "Times New Roman", color: "#0e4794"}}>
                                        europasrl@pec.it
                                    </p>
                                </div>
                            </Col>

...
export default class Index extends React.Component {
  ...
  render() {
    return (
      <Layout>
        <MiniHero heading={"Privacy Policy"} />
            ...
            <Row className="justify-content-center">
              <Col lg="12">
                <p>
                  ...
                  <p>Noi di <strong><span id="sito">www.europadigitaldivision.it</span></strong> riteniamo che la privacy dei nostri visitatori sia estremamente importante. Questo documento descrive dettagliatamente i tipi di informazioni personali raccolti e registrati dal nostro sito e come essi vengano utilizzati.</p>
                  <h5>File di Registrazione (Log Files)</h5>
                  ...
                  <div id="cookies">
                    <h5>Questo sito web utilizza i Cookies</h5>
                    ...
                    <h5>Come disabilitare i Cookies</h5>
                  ...
                  <div id="fornitori">
                    <h5>Fornitori di terze parti</h5>
                  ...
                  <div id="partners">
                    <h5>I nostri partner pubblicitari</h5>
                    ...
                    <ul>
                      <li id="altri_partner"><span id="partner">Google Analytics</span></li>
                    </ul>
                    ...
                    <h5>Norme sulla privacy di terze parti</h5>
                  ...
                  <h5>Natura obbligatoria</h5>
                  <p>Tutti i dati richiesti sono obbligatori.</p>
                  <div id="trattamento">
                    <h5>Soggetti a cui dati potranno essere comunicati i dati personali</h5>
                  ...
                  <ul>
                    <li><b><span id="azienda">Mimmo Busacca</span></b></li>
                    <li id="piva">P. IVA <span id="iva">03161700830</span></li>
                    <li><span id="indirizzo">Via Garibaldi 268</span></li>
                    <li><span id="cap"> 98121</span> - <span id="citta">Messina</span> (<span id="provincia">ME</span>)</li>
                    <li>Tel/Fax: <span id="telefono">3517155160</span></li>
                    <li>E-mail: <span id="email">europasrl@pec.it</span></li>
                  </ul>
                  ...
                  <h5>Informazioni per i bambini</h5>

            ...
            <section className="section section-lg bg-gradient-default">
                <Container className="pt-lg pb-300">
                    <Row className="text-center justify-content-center">
                        <Col lg="10">
                            <h2 className="display-3 text-white">Cresci insieme a noi perché</h2>
                            <h2 className="display-3 text-white"><b>IL DIGITALE RESTERÀ</b></h2>
                            <p className="lead text-white">
                                Secondo uno studio del Cisco & IMD Glogbal Center for Business trasformation,
                                nei prossimi 5 anni, 4 società su 10 falliranno o perderanno la loro leadership di
                                mercato a causa di una mancata digitalizzazione del loro modello di business.
                            </p>
                        </Col>
                    </Row>
                    <Row className="row-grid mt-5">
                        <Col lg="6">
                            ...
                            <h5 className="text-white mt-3">Strumenti di costruzione</h5>
                            <p className="text-white mt-3">
                                Gli strumenti del web marketing permettono di costruire una presenza online del proprio
                                business, che aumenterà la notorietà della propria attività e del proprio brand.
                            </p>
                        </Col>
                        <Col lg="6">
                            <div
                            ...
                            <h5 className="text-white mt-3">Fai crescere il tuo mercato</h5>
                            <p className="text-white mt-3">
                                Sito web, presenza digitale, pubblicità online. In base alle tue ambizioni e modello di
                                business, con noi, potrai accedere agli strumenti digitali necessari a far crescere la
                                tua attività.
                            </p>
                        </Col>
                    </Row>
